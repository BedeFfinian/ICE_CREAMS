...
- This installs all the versions of the necessary packages for all the notebooks in this repository into a virtual environment called 'ICE_CREAMS'. (As of: `r Sys.Date()`)
...
- Apply this .pkl file to a Copernicus .SAFE file (with an accompanying intertidal mask file that the user must create in the same CRS as the)
